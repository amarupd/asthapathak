        ...
        <header className="backdrop-blur-sm sticky top-0 z-40">
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="rounded-full w-14 h-14 bg-gradient-to-tr from-indigo-600 to-pink-500 flex items-center justify-center text-white font-semibold shadow-xl">AP</div>
              <div>
        ...
        <main className="container mx-auto px-6 py-12">
          ...
          <section className="grid md:grid-cols-3 gap-8 items-center">
            <div className="md:col-span-2">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">Hi, I'm {contact.name} <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-pink-500">— HR Business Partner</span></h2>
            ...
            >
              <div className="absolute -top-8 -right-8 w-40 h-40 rounded-full bg-gradient-to-tr from-pink-400 to-indigo-400 opacity-40 blur-2xl"></div>
          ...
          <section
            ...
            className="mt-10 p-6 rounded-2xl 
             bg-gradient-to-br 
             from-violet-500/30 to-rose-400/30
             dark:from-violet-700/40 dark:to-fuchsia-500/20
              ...
              {skills.map((s, i) => (
                <div key={i}>
                  ...
                  <div className="w-full bg-neutral-200 dark:bg-neutral-700 h-2 rounded-full mt-2">
                    <div className="h-2 rounded-full shadow-sm" style={{ width: `${s.level}%`, background: 'linear-gradient(90deg,#7c3aed,#06b6d4)' }}></div>
                  </div>
                </div>
              ))}
            </div>
              ...
              {projects.map((p, i) => (
                <div
                  ...
                  className="p-4 rounded-xl shadow-lg 
                   bg-gradient-to-br 
                   from-fuchsia-400/20 to-indigo-400/20 
          ...
          {/* Contact / CTA */}
          <section id="contact" className="mt-10 p-8 rounded-2xl bg-gradient-to-r from-indigo-600 to-pink-500 text-white shadow-lg">
